...
export default {
  ...
  mounted() {
    this.dadataToken = import.meta.env.VITE_DADATA_TOKEN || ''
    console.log('🔑 Токен в RequestModal:', this.dadataToken ? '✅ Есть' : '❌ Нет')
    if (!this.form.date) {
...
@media (max-width: 768px) {
  .modal { padding: 16px; }
  .modal-content { padding: 32px 24px 28px; max-height: 90vh; min-height: auto; border-radius: 20px; }
  .modal-content h2 { font-size: 26px; margin-bottom: 28px; }
  .request-form input, .request-form textarea { padding: 12px 16px; font-size: 15px; margin-bottom: 16px; }
  .request-form button { height: 52px; font-size: 15px; }
}

@media (max-width: 480px) {
  .modal { padding: 10px; align-items: flex-end; }
  .modal-content { padding: 24px 16px 20px; min-height: auto; max-height: 95vh; border-radius: 16px 16px 0 0; }
  .modal-content h2 { font-size: 22px; margin-bottom: 20px; }
  .request-form label { font-size: 13px; margin-bottom: 6px; }
  .request-form input, .request-form textarea { padding: 10px 14px; font-size: 14px; border-radius: 20px; margin-bottom: 12px; }
  .request-form textarea { height: 80px; min-height: 60px; }
  .request-form button { height: 46px; font-size: 14px; border-radius: 20px; margin-top: 8px; }
  .modal-close { top: 12px; right: 12px; font-size: 20px; width: 32px; height: 32px; }
  .error { font-size: 11px; min-height: 16px; margin-bottom: 6px; }
  .success-message, .error-message { font-size: 13px; padding: 10px 14px; margin-top: 12px; }
}
</style>